...
namespace ZDebug.Core.Instructions
{
    public static class OpcodeTable
    {
        ...
        static OpcodeTable()
        {
            ...
            AddOpcode(OpcodeKind.TwoOp, 0x1b, "set_color", routine: OpcodeRoutines.set_color, fromVersion: 5, toVersion: 5);
            AddOpcode(OpcodeKind.TwoOp, 0x1b, "set_color", fromVersion: 6, toVersion: 6);
            AddOpcode(OpcodeKind.TwoOp, 0x1b, "set_color", routine: OpcodeRoutines.set_color, fromVersion: 7);
            ...
            AddOpcode(OpcodeKind.ZeroOp, 0x0c, "show_status", routine: OpcodeRoutines.show_status, fromVersion: 3, toVersion: 3);
            ...
            AddOpcode(OpcodeKind.VarOp, 0x13, "output_stream", routine: OpcodeRoutines.output_stream, fromVersion: 3, toVersion: 4);
            AddOpcode(OpcodeKind.VarOp, 0x13, "output_stream", routine: OpcodeRoutines.output_stream, fromVersion: 5, toVersion: 5);
            AddOpcode(OpcodeKind.VarOp, 0x13, "output_stream", fromVersion: 6, toVersion: 6);
            AddOpcode(OpcodeKind.VarOp, 0x13, "output_stream", routine: OpcodeRoutines.output_stream, fromVersion: 7);
