...
internal sealed partial class ZTextGridWindow : ZWindow
{
    ...
    public override void PutChar(char ch) => textGrid.PutChar(ch);

    public override int GetCursorColumn() => textGrid.GetCursorX();

    public override int GetCursorLine() => textGrid.GetCursorY();

    public override void SetCursor(int x, int y) => textGrid.SetCursor(x, y);
