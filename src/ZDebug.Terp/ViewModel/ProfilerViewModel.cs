...
internal sealed class ProfilerViewModel : ViewModelWithViewBase<UserControl>
{
    ...
    private void ProfilerService_Starting(object sender, ProfilerStartingEventArgs e) => ClearProfilerData();

    private void ProfilerService_Stopped(object sender, ProfilerStoppedEventArgs e) => PopulateProfilerData();
    ...
    private void PopulateProfilerData()
    {
        ...
        Dispatch(() =>
        {
            callTreeRoot = [profilerService.Profiler.RootCall];
