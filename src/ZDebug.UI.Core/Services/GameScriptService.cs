...
public class GameScriptService : IService, IPersistable
{
    ...
    private void StoryService_StoryClosed(object sender, StoryClosedEventArgs e) => commands.Clear();
    ...
    public bool HasNextCommand() => commandIndex >= 0 && commandIndex < commands.Count;
