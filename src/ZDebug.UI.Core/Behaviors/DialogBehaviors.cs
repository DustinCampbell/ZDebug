...
public static class DialogBehaviors
{
    ...
    public static bool GetIsAccept(DependencyObject obj) => (bool)obj.GetValue(IsAcceptProperty);

    public static void SetIsAccept(DependencyObject obj, bool value) => obj.SetValue(IsAcceptProperty, value);
}
