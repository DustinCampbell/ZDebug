    ...
    where TView : ContentControl
{
    ...
    protected void Dispatch(Action method, DispatcherPriority priority) => View.Dispatcher.BeginInvoke(method, priority);

    protected void Dispatch(Action method) => Dispatch(method, DispatcherPriority.Normal);
    ...
    public TView CreateView()
    {
        ...
        view = Application.LoadComponent(uri) as TView;
