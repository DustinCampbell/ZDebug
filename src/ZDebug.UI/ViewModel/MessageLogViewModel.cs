...
internal sealed class MessageLogViewModel : ViewModelWithViewBase<UserControl>, IMessageLog
{
    ...
    public void SendError(string message) => messages.Add(MessageViewModel.CreateError(message));

    public void SendWarning(string message) => messages.Add(MessageViewModel.CreateWarning(message));
