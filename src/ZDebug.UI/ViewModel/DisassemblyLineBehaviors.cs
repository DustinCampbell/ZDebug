...
internal static class DisassemblyLineBehaviors
{
    ...
    public static bool GetTogglesBreakpointOnClick(DependencyObject obj) => (bool)obj.GetValue(TogglesBreakpointOnClickProperty);

    public static void SetTogglesBreakpointOnClick(DependencyObject obj, bool value) => obj.SetValue(TogglesBreakpointOnClickProperty, value);
}
