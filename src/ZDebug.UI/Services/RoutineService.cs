...
internal class RoutineService : IService, IPersistable
{
    ...
    private void StoryService_StoryOpened(object sender, StoryOpenedEventArgs e) => routineTable = new ZRoutineTable(e.Story);

    private void StoryService_StoryClosed(object sender, StoryClosedEventArgs e) => routineTable = null;

    // TODO: Hide this when there's a debugger service with an appropriate event.
    public void Add(int address) => routineTable.Add(address);
