...
internal class BreakpointService : IService, IPersistable
{
    ...
    private readonly SortedSet<int> breakpoints = [];
    ...
    private void StoryService_StoryClosed(object sender, StoryClosedEventArgs e) => breakpoints.Clear();
    ...
    public bool Exists(int address) => breakpoints.Contains(address);
