...
internal class DebuggerService : IService
{
    ...
    private void Machine_Quit(object sender, EventArgs e) => ChangeState(DebuggerState.Done);
    ...
    public void StopDebugging() => stopping = true;
    ...
    {
        get => state != DebuggerState.Running
              && state != DebuggerState.Unavailable && hasStepped;
    }

    public void ResetSession()
    {
        var fileName = storyService.FileName;
