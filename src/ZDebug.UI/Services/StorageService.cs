...
internal class StorageService : IService
{
    ...
    {
        storyPersistence = storyService;
        storyService.StoryOpened += StoryService_StoryOpened;
        storyService.StoryClosing += StoryService_StoryClosing;
        breakpointPersistence = breakpointService;
        gameScriptPersistence = gameScriptService;
        routinePersistence = routineService;
    }

    private void StoryService_StoryOpened(object sender, StoryOpenedEventArgs e) => LoadSettings(e.Story);

    private void StoryService_StoryClosing(object sender, StoryClosingEventArgs e) => SaveSettings(e.Story);
