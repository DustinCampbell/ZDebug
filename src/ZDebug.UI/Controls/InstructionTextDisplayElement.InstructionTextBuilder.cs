...
internal partial class InstructionTextDisplayElement
{
    private class InstructionTextBuilder
    {
        ...
        {
            defaultParagraphProps = new SimpleTextParagraphProperties(FontsAndColorsService.DefaultSetting);

            textSource = new InstructionTextSource();
        }

        public void Clear() => textSource.Clear();
        ...
        public void AddAddress(int address) => AddText(address.ToString("x4"), FontsAndColorsService.AddressSetting);
        ...
        public void AddConstant(ushort value) => AddText("#" + value.ToString("x4"), FontsAndColorsService.ConstantSetting);

        public void AddConstant(byte value) => AddText("#" + value.ToString("x2"), FontsAndColorsService.ConstantSetting);

        public void AddKeyword(string text) => AddText(text, FontsAndColorsService.KeywordSetting);
        ...
        public void AddSeparator(string text) => AddText(text, FontsAndColorsService.SeparatorSetting);
        ...
        public void AddZText(string ztext) => AddText(ztext, FontsAndColorsService.ZTextSetting);
    }
}
