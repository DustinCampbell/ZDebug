...
internal partial class InstructionTextDisplayElement
{
    ...
    {
        private readonly struct FormattedSpan
        {
        ...
        private static readonly Dictionary<int, SimpleTextRunProperties> propMap = [];

        private readonly TextRunCache cache = new TextRunCache();
        private readonly StringBuilder textBuilder = new StringBuilder();
        private readonly List<FormattedSpan> spans = [];
        ...
        public override TextSpan<CultureSpecificCharacterBufferRange> GetPrecedingText(int textSourceCharacterIndexLimit) => new TextSpan<CultureSpecificCharacterBufferRange>(0, new CultureSpecificCharacterBufferRange(CultureInfo.CurrentUICulture, new CharacterBufferRange("", 0, 0)));
