...
internal partial class InstructionTextDisplayElement : FrameworkElement
{
    ...
    {
        storyService = App.Current.GetService<StoryService>();
        builder = new InstructionTextBuilder();
    ...
    protected override void OnRender(DrawingContext drawingContext) => builder.Draw(drawingContext, DesiredSize.Width);
    ...
    {
        get => (Instruction)GetValue(InstructionProperty); set => SetValue(InstructionProperty, value);
    }
}
