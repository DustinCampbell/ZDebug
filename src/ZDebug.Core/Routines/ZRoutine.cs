...
public sealed class ZRoutine
{
    ...
    private readonly ReadOnlyMemory<ushort> locals;
    private string name;
    ...
    public ReadOnlySpan<Instruction> Instructions => instructions.Span;

    public ReadOnlySpan<ushort> Locals => locals.Span;
