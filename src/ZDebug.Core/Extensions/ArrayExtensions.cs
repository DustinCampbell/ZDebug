...
{
    public static bool Any<T>(this T[] array, Predicate<T> predicate) => Array.FindIndex(array, predicate) >= 0;

    public static ReadOnlyCollection<T> AsReadOnly<T>(this T[] array) => Array.AsReadOnly(array);

    public static string AsString(this char[] array) => new string(array);
    ...
    public static bool Contains<T>(this T[] array, T value) => Array.IndexOf(array, value) >= 0;
