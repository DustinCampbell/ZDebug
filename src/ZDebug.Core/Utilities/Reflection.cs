...
public static partial class Reflection<T>
{
    ...
    private static readonly Dictionary<FieldInfoKey, FieldInfo> fieldCache = [];
    private static readonly Dictionary<MethodInfoKey, MethodInfo> methodCache = [];
    private static readonly Dictionary<ConstructorInfoKey, ConstructorInfo> constructorCache = [];
