...
public abstract partial class ZMachine
{
    protected class OutputStreamCollection
    {
        ...
        internal OutputStreamCollection(Story story)
        {
            this.story = story;
            memory = story.Memory;
            memoryStreams = new Stack<MemoryOutputStream>();
        ...
        public void SelectScreenStream() => screenActive = true;

        public void DeselectScreenStream() => screenActive = false;
        ...
        public void DeselectMemoryStream() => memoryStreams.Pop();
