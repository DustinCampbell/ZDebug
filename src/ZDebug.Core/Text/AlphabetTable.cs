...
internal sealed class AlphabetTable
{
    ...
    public void Reset() => currentAlphabet = baseAlphabet;

    public void Shift() => currentAlphabet = (baseAlphabet + 1) % 3;

    public void DoubleShift() => currentAlphabet = (baseAlphabet + 2) % 3;
