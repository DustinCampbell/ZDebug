...
public static class Header
{
    ...
    public static byte ReadVersion(byte[] memory) => memory.ReadByte(VersionIndex);

    public static ushort ReadReleaseNumber(byte[] memory) => memory.ReadWord(ReleaseNumberIndex);

    public static ushort ReadHighMemoryBase(byte[] memory) => memory.ReadWord(HighMemoryBaseIndex);

    public static ushort ReadInitialPC(byte[] memory) => memory.ReadWord(InitialPCIndex);
    ...
    public static ushort ReadDictionaryAddress(byte[] memory) => memory.ReadWord(DictionaryAddressIndex);

    public static ushort ReadObjectTableAddress(byte[] memory) => memory.ReadWord(ObjectTableAddressIndex);

    public static ushort ReadGlobalVariableTableAddress(byte[] memory) => memory.ReadWord(GlobalVariableTableAddressIndex);

    public static ushort ReadStaticMemoryBase(byte[] memory) => memory.ReadWord(StaticMemoryBaseIndex);
    ...
    public static string ReadSerialNumberText(byte[] memory) => Header.ReadAsciiString(memory, SerialNumberIndex, 6);

    public static ushort ReadAbbreviationsTableAddress(byte[] memory) => memory.ReadWord(AbbreviationTableAddressIndex);
    ...
    public static ushort ReadRoutinesOffset(byte[] memory) => memory.ReadWord(RoutinesOffsetIndex);

    public static ushort ReadStringsOffset(byte[] memory) => memory.ReadWord(StringsOffsetIndex);

    public static ushort ReadTerminatingCharactersTableAddress(byte[] memory) => memory.ReadWord(TerminatingCharactersTableAddressIndex);

    public static ushort ReadAlphabetTableAddress(byte[] memory) => memory.ReadWord(AlphabetTableAddressIndex);

    public static ushort ReadHeaderExtensionTableAddress(byte[] memory) => memory.ReadWord(HeaderExtensionTableAddressIndex);
    ...
    public static string ReadInformVersionText(byte[] memory) => Header.ReadAsciiString(memory, InformVersionNumberIndex, 4);

    public static void WriteScreenHeightInLines(byte[] memory, byte screenHeight) => memory.WriteByte(0x20, screenHeight);

    public static void WriteScreenWidthInColumns(byte[] memory, byte screenWidth) => memory.WriteByte(0x21, screenWidth);

    public static void WriteScreenHeightInUnits(byte[] memory, ushort screenHeight) => memory.WriteWord(0x24, screenHeight);

    public static void WriteScreenWidthInUnits(byte[] memory, ushort screenWidth) => memory.WriteWord(0x22, screenWidth);
