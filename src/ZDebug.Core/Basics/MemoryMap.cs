...
public sealed class MemoryMap : IIndexedEnumerable<MemoryMapRegion>
{
    ...
    private void AddObjectTableRegions(byte[] memory)
    {
        ...
        var objectAddress = objectTableBase + ObjectHelpers.GetPropertyDefaultsTableSize(version);
    ...
    public MemoryMapRegion this[int index] => regions[index];

    public MemoryMapRegion this[MemoryMapRegionKind kind] => kindToRegionMap[kind];
