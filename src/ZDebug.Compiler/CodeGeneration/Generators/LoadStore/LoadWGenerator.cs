...
internal class LoadWGenerator : LoadMemoryGenerator
{
    ...
    protected override void LoadMemory(int address, ICompiler compiler) => compiler.EmitLoadMemoryWord(address);

    protected override void LoadMemory(ILocal address, ICompiler compiler) => compiler.EmitLoadMemoryWord(address);
