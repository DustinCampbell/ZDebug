...
internal class StoreBGenerator : StoreMemoryGenerator
{
    ...
    protected override int CalculateAddress(int address, int offset) => address + offset;
    ...
    protected override void StoreMemory(int address, ILocal value, ICompiler compiler) => compiler.EmitStoreMemoryByte(address, value);

    protected override void StoreMemory(ILocal address, ILocal value, ICompiler compiler) => compiler.EmitStoreMemoryByte(address, value);
