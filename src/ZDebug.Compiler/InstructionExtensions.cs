...
internal static class InstructionExtensions
{
    ...
    private static bool Is(this Opcode op, OpcodeKind kind, int number) => op.Kind == kind && op.Number == number;

    public static bool IsCall(this Instruction i) => i.Opcode.IsCall;
