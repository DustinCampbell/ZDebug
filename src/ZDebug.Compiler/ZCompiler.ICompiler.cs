...
internal partial class ZCompiler : ICompiler
{
    ...
    public void EmitObjectHasAttribute(ILocal objectNumber, ILocal attributeNumber) => ObjectHasAttribute(objectNumber, attributeNumber);

    public void EmitObjectChangeAttribute(ILocal objectNumber, ILocal attributeNumber, bool value) => ObjectSetAttribute(objectNumber, attributeNumber, value);

    public void EmitLoadFirstPropertyAddress(ILocal objectNumber) => FirstProperty(objectNumber);

    public void EmitLoadNextPropertyAddress() => NextProperty();
    ...
    public void EmitObjectRemoveFromParent(ILocal objectNumber) => RemoveObjectFromParent(objectNumber);

    public void EmitObjectMoveToDestination(ILocal objectNumber, ILocal destinationNumber) => MoveObjectToDestination(objectNumber, destinationNumber);
