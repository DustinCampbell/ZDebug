...
{
    private static readonly MethodInfo debugIndent = typeof(Debug).GetMethod(
        name: "Indent",
    ...
    private static readonly MethodInfo debugUnindent = typeof(Debug).GetMethod(
        name: "Unindent",
        bindingAttr: BindingFlags.Public | BindingFlags.Static,
        binder: null,
        types: Types.None,
    ...
    private static readonly MethodInfo debugWriteLine = typeof(Debug).GetMethod(
        name: "WriteLine",
        bindingAttr: BindingFlags.Public | BindingFlags.Static,
        binder: null,
    ...
    [Conditional("LOG")]
    public void DebugIndent() => Call(debugIndent);

    [Conditional("LOG")]
    public void DebugUnindent() => Call(debugUnindent);
}
