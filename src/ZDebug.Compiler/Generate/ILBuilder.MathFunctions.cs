...
public sealed partial class ILBuilder
{
    public sealed class MathFunctions : FunctionSet
    {
        ...
        public void Add() => builder.il.Emit(OpCodes.Add);
        ...
        public void Subtract() => builder.il.Emit(OpCodes.Sub);
        ...
        public void Multiply() => builder.il.Emit(OpCodes.Mul);
        ...
        public void Divide() => builder.il.Emit(OpCodes.Div);
        ...
        public void Remainder() => builder.il.Emit(OpCodes.Rem);
        ...
        public void And() => builder.il.Emit(OpCodes.And);
        ...
        public void Or() => builder.il.Emit(OpCodes.Or);
        ...
        public void Not() => builder.il.Emit(OpCodes.Not);

        public void Shl() => builder.il.Emit(OpCodes.Shl);
        ...
        public void Shr() => builder.il.Emit(OpCodes.Shr);
        ...
        public void Negate() => builder.il.Emit(OpCodes.Neg);
        ...
        public void Increment(ILocal local) => Increment(local, 1);
    }
}
